export default class ErrorMessages {
    ...
    static WRONG_PASSWORD = 'The password you entered is incorrect. Please try again.'
    static WRONG_USERNAME = 'The username you entered does not exist. Please try again.'
}
